...
public class TestFileConfiguratorRootNoUserName extends DefaultFileConfigurator
	implements FileConfigurator {

    /** Debug info */
    private static boolean DEBUG = FrameworkDebug
	    .isSet(TestFileConfiguratorRootNoUserName.class);

    /**
     * Default constructor
     */
    public TestFileConfiguratorRootNoUserName() {
	...
	String root = super.getServerRoot().toString();
	root += "-file";
	
	String content = root + "!" + false;
	try {

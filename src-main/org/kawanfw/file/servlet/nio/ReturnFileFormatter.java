 ...
 * <ul>
 * <li>Pass from Windows to Uinx notation.</li>
 * <li>Remove FileConfigurator.getServerRoot() from name.<li>
...
public class ReturnFileFormatter {
	...
	if (serverRootFile == null
		|| serverRootFile.toString().equals("/")
		|| serverRootFile.toString().toLowerCase()
			.equals("c:\\")) {
	...
	String headerServeroot = fileConfigurator.getServerRoot().toString();
...
//	}
	...
	// Remove the header
	result = StringUtils.substringAfter(result, headerServeroot);

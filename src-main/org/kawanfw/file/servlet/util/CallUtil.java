...
public class CallUtil {
     ...
     */
    public CallUtil(Class<?> clazz, FileConfigurator fileConfigurator) {
	this.clazz = clazz;
	...
	if (fileConfigurator.getServerRoot() != null) {
	    String serverRoot = fileConfigurator.getServerRoot().toString();
	    if (file.toString().toLowerCase()
		    .startsWith(serverRoot.toLowerCase())) {
		throw new SecurityException(
			Tag.PRODUCT_SECURITY
				+ " Call of classes located inside the "
				+ Tag.PRODUCT
				+ " server path (fileConfigurator.getServerRoot()) are not authorized.");
	    }

...
//		+ file.setWritable(writable, ownerOnly));
	...
	String root ="c:\\";
	String koalaInRoot = "C:\\.awake-server-root-file\\username\\koala.jpg";
	String koalaInMyRep = "C:\\.awake-server-root-file\\username\\my_rép1\\koala.jpg";
	...
	String [] dirsToTest = new String [] {root, "C:\\.awake-server-root-file\\username", "c:\\notexists"};
